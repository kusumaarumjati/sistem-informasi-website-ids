              ...
              <div class="col-md-12">
			    ...
			    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{$book[0]->name}}" class="form-control" placeholder="Nama" required="required">
                  </div>
                
                  <div class="form-group">
                    <label for="alamat">Author</label>
                    <input type="text" name="author" id="author" value="{{$book[0]->author}}" class="form-control"  placeholder="Author" required="required">
                  </div>
